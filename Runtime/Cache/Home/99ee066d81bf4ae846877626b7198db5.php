...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
    <div style="width: 0;height:0;display: none" id="html"><?php echo ($ctn); ?></div>
       <h1 class="page-header">笔记修改</h1>
     <div id="warp">
    <div class="fromdata">
      <div class="item">
        <span class="lableitem" for="titlename">标题</span>
        <input id="titlename" name="titlename" placeholder="请输入标题" value="<?php echo ($json["title"]); ?>">
      </div>
      <div class="item">
      ...
      <div class="item" placeholder="请输入描述">
        ...
        <input id="desbute" name="desbute" placeholder="请输入描述" value="<?php echo ($json["des"]); ?>">
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function sendsoure(){
    	var id = "<?php echo ($json["id"]); ?>";
    	layer.load();
      	var url="/tpnote/index.php/home/admin/updatenote";
      	var data = {
