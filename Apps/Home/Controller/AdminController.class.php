...
class AdminController extends BaseController{
    ...
    public function uuuuu(){
    	$list = $model = M('notetable')->select();
    	foreach ($list as $key => $value) {
    		$m = M('notetable');
    		$id = $value['id'];
    		$m->ctn = htmlspecialchars($value['ctn']);
    		$m->where("id=$id")->save();
    	}
    }
	...
	public function editnote(){
		...
		$this->assign('ctn',htmlspecialchars_decode($result['ctn']));
		$this->display();
	}
